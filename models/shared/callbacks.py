...
class CorrelationMetricsLogCallback(pl.Callback):
    ...
    def test_model(self, trainer, pl_module):
        ...
        for batch in loader:
            ...
            print('data_return_latent')
            print(self.dataset.return_latents)
            print('data_return_robot_state')
            print(self.dataset.return_robot_state)
            print('data_return_targets')
            print(self.dataset.return_targets)
            print('data_triplet')
            print(self.dataset.triplet)
            print('data_single_image')
            print(self.dataset.single_image)
            print('other')
            print(other)
            exit()
